...
export const getJuryByIdResponse = {
  ...
  schema: {
    properties: {
      ...
      votes: { type: 'array', items: { properties: vote } },
      plaintiffVoteCount: { type: 'integer' },
      defendantVoteCount: { type: 'integer' },
    },
  },
};
...
export const getJuryPaginationResponse = {
  ...
  schema: {
    properties: {
      ...
      list: {
        type: 'array',
        items: { type: 'object', properties: jury },
      },
    },
  },
};
...
export const getCommentPaginationResponse = {
  ...
  schema: {
    properties: {
      ...
      list: {
        type: 'array',
        items: { type: 'object', properties: comment },
      },
    },
  },
};
